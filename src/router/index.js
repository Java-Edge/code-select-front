...
const routes = [
...

  {
    ...
    component: () => import("../views/markdown/article-interview"),
    meta: { requiresAuth: true }
  },
  {
    path: ROUTE_PATHS.ARTICLE_DETAIL,
    name: "intervieArticleDetail",
    component: () => import("../views/markdown/interview-article-detail"),
    meta: { requiresAuth: true }
  },
  {
    path: ROUTE_PATHS.SPECIAL,
    name: "special-column",
    component: () => import("../views/special-column/index"),
    meta: { requiresAuth: true }
  },

  {
    ...
    name: "profile",
    component: () => import("../views/profile/profile-page"),
    meta: { requiresAuth: true }
  },
];
